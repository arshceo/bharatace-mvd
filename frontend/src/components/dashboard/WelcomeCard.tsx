      ...
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <div className="flex items-center space-x-3 mb-3">
            <div className="h-12 w-12 bg-white bg-opacity-20 rounded-full flex items-center justify-center backdrop-blur-sm">
          ...
          {studentData && (
            <div className="mt-6 grid grid-cols-2 gap-4">
              ...
              <div className="bg-white bg-opacity-10 rounded-lg p-3 backdrop-blur-sm col-span-2">
        ...
        <div className="ml-4">
          <div className="h-20 w-20 bg-white bg-opacity-10 rounded-full flex items-center justify-center backdrop-blur-sm">
        ...
        <div className="mt-6 pt-6 border-t border-white border-opacity-20">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-white bg-opacity-20 backdrop-blur-sm">
